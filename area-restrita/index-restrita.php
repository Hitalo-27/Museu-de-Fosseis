  ...
  <div class="hero">
    ...
    <div class="header-container">
      ...
      <center>
        ...
        <br>
        <h1>Conheça as nossas principais Exposições.</h1>
      </center>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm">
            ...
            <div class="card" style="background-color:#614f37; color: #FFFFFF;   border:10px solid #4C0013; border-radius: 10px;">
              <img class="card-img-top car" src="../img/Abelissauro.jpg" alt="Imagem de capa do card">
              <div class="card-body">
                <h5 class="card-title">
                  Fossil: Abelissauro
                  <br>
                ...
                <a href="exposicoes.php" class="btns" style="width: 60%;">Ver Mais Informações</a>
              </div>
            </div>

            <div class="card" style="background-color:#614f37; color: #FFFFFF;   border:10px solid #4C0013; border-radius: 10px;">
              <img class="card-img-top car" src="../img/Adamantisaurus.png" alt="Imagem de capa do card">
              <div class="card-body">
                <h5 class="card-title">
                  Fossil: Adamantisaurus
                  <br>
                  Periodo: Cretáceo
                  <br>
                  <br>
            ...
            <div class="card" style="background-color:#614f37; color: #FFFFFF;   border:10px solid #4C0013; border-radius: 10px;">
              <img class="card-img-top car" src="../img/Amazonsaurus.jpg" alt="Imagem de capa do card">
              <div class="card-body">
                <h5 class="card-title">
                  Fossil: Amazonsaurus
                  <br>
            ...
            <div class="card" style="background-color:#614f37; color: #FFFFFF;   border:10px solid #4C0013; border-radius: 10px;">
              <img class="card-img-top car" src="../img/Buriolestes.jpg" alt="Imagem de capa do card">
              <div class="card-body">
                <h5 class="card-title">
                  Fossil: Buriolestes
                  <br>
            ...
            <div class="card" style="background-color:#614f37; color: #FFFFFF;   border:10px solid #4C0013; border-radius: 10px;">
              <img class="card-img-top car" src="../img/Iguanodon2.jpg" alt="Imagem de capa do card">
              <div class="card-body">
                <h5 class="card-title">
                  Fossil: Iguanodon
                  <br>
            ...
            <div class="card" style="background-color:#614f37; color: #FFFFFF;   border:10px solid #4C0013; border-radius: 10px;">
              <img class="card-img-top car" src="../img/Pycnonemosaurus.jpg" alt="Imagem de capa do card">
              <div class="card-body">
                <h5 class="card-title">
                  Fossil: Pycnonemosaurus
                  <br>
                  Periodo: Cretáceo
                  <br>
                  <br>
